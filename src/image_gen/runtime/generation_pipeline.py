        ...
        try:
            ...
            if outpaint_enabled:
                ...
                requested_handoff = str(
                    getattr(request, "_outpaint_runtime_source_handoff_requested", "pixel_vae_reencode")
                ...
                outpaint_metadata.update({
                    ...
                    "source_handoff": {
                        **handoff,
                        ...
                        "source_was_vae_reencoded_for_protected_latent": handoff["actual"] != "live_latent",
                        "live_source_latent_reused": handoff["actual"] == "live_latent",
