...
def default_adapter_loader_registry() -> AdapterLoaderRegistry:
    capability = AdapterLoaderCapability(
        ...
        supported_families=frozenset({"sd1", "sd2", "sdxl", "sd3"}),
        supported_targets=frozenset({"unet", "transformer", "text_encoder", "text_encoder_2", "text_encoder_3", "linear", "convolution"}),
        family_target_overrides={
            ...
            "sd3": frozenset({"transformer", "text_encoder", "text_encoder_2", "text_encoder_3", "linear", "convolution"}),
        },
