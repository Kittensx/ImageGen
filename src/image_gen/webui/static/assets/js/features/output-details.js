...
const SECTION_DEFINITIONS = [
  ...
  },
  {
    ...
    fields: [
      ...
      ["T5 conditioning enabled", "replay.sd3_t5_enabled", "sd3_t5_enabled"],
      ["T5 conditioning source", "replay.sd3_t5_source", "sd3_t5_source"],
      ["T5 execution device", "replay.text_encoder_3_device", "text_encoder_3_device"],
      ["LoRAs", "image.loras"],
