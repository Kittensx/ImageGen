        ...
        return {
            ...
            "api_contract": {
                ...
                "asset_hub_routes": [
                    ...
                    "/api/asset-hub/index/status",
                    "/api/asset-hub/index/search",
                    "/api/asset-hub/index/models/{provider_id}/{model_id}",
                    "/api/asset-hub/search-sessions",
                    "/api/asset-hub/search-sessions/{session_id}",
                    "/api/asset-hub/search-sessions/{session_id}/stop",
                    "/api/asset-hub/search-sessions/{session_id}/close",
                    "/api/asset-hub/selections/{purpose}",
                    ...
                    "/api/asset-hub/installed/{install_id}/open-folder",
            ...
            **prompt_configuration.bootstrap_payload(),
            ...
            # The remembered checkpoint may not yet be resident after a backend
            # restart. Resolve capabilities from the effective generation selection
            # so sampler/scheduler guardrails are correct while GPU warm-up happens
            # independently in the background.
            "generation_capabilities": generation_capabilities.resolve_request(request=effective_generation),
