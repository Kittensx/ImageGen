...
This folder contains chronological user-facing notes for substantial ImageGen source/release updates.

The changelog records what changed in a published development snapshot. The durable current feature inventory lives in [`features/CURRENT.md`](../features/CURRENT.md), while future/planned work lives in [`features/UPCOMING.md`](../features/UPCOMING.md).
...
A changelog entry is historical. It should not be used as the authoritative statement of what the current build supports after later releases change behavior.
