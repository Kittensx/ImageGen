...
def build_generation_manifest(
    ...
    if request is not None:
        ...
        for field_name, default in (
            ...
            ("hires_axis_scale_width", 1.0),
            ("hires_axis_scale_height", 1.0),
            ...
            ("hires_diagnostic_vae_execution_fingerprint", False),
            ("hires_save_lowres", False),
            ("hires_memory_preflight", True),
            ("hires_host_staging_policy", "pageable"),
            ("hires_host_staging_cap_mb", 1024),
            ("hires_artifact_disk_budget_mb", 0),
            ("prompt_shadow_compare", False),
            ("prompt_route_plan", {}),
            ("hires_prompt_route_plan", {}),
            ("outpaint_enabled", False),
            ("outpaint_target_width", 0),
            ("outpaint_target_height", 0),
            ("outpaint_preservation_mode", "strict_preserve"),
            ("outpaint_mask_strategy", "preserve_generate_feather_v1"),
            ("outpaint_source_handoff_mode", "image_reencode_v1"),
            ("outpaint_prototype_enabled", False),
            ("outpaint_source_image", ''),
            ("outpaint_anchor", 'center'),
            ("outpaint_source_x", -1),
            ("outpaint_source_y", -1),
            ("outpaint_feather_px", 24),
            ("outpaint_context_seed_mode", "edge_pad_v1"),
            ("outpaint_denoising_strength", 0.7),
            ("outpaint_latent_strategy", 'noise_only_new_regions_v1'),
            ("outpaint_prompt_mode", 'source_prompt_v1'),
            ...
            ("outpaint_shape_expansion_enabled", False),
            ("outpaint_shape_target_mode", "square"),
            ("outpaint_shape_target_width", 0),
            ("outpaint_shape_target_height", 0),
            ("outpaint_shape_base_width", 0),
            ("outpaint_shape_base_height", 0),
            ("outpaint_shape_anchor", "center"),
            ("outpaint_shape_context_seed_mode", "edge_pad_v1"),
            ("outpaint_shape_source_handoff", "auto"),
            ("outpaint_shape_prompt_mode", "overlay_only_v1"),
            ("outpaint_shape_overlay_positive_prompt", ""),
            ("outpaint_shape_overlay_negative_prompt", ""),
            ("outpaint_shape_denoising_strength", 0.40),
